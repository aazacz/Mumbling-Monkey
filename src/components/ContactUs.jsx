...
const ContactUs = () => {
    return (
        <>
            <div className='w-full md:w-[90%] h-auto py-6 md:px-14 px-3 flex flex-col items-center'>
                ...
                <div className='w-full h-auto flex flex-col md:flex-row-reverse md:gap-9'>
                    ...
                    <div className='md:w-1/2 w-full flex flex-col items-center md:items-end px-6 pt-6 md:pt-0 rounded-xl bg-gray-200 justify-center'>
                        ...
                        <div className='mt-5 w-full flex flex-col items-center gap-2'>
                            <div className='bg-white w-max px-2 py-1 text-xs md:text-base rounded-2xl flex items-center gap-x-2'>
